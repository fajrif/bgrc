...
ActiveRecord::Schema[7.1].define(version: 2026_09_16_000002) do
  ...
  create_table "bookings", force: :cascade do |t|
    ...
    t.datetime "payment_window_reset_at"
    t.datetime "checkout_extended_at"
    t.index ["court_id"], name: "index_bookings_on_court_id"
    t.index ["status", "expires_at"], name: "index_bookings_on_status_and_expires_at"
  ...
  create_table "class_credit_purchases", force: :cascade do |t|
    ...
    t.index ["status", "payment_expires_at"], name: "index_class_credit_purchases_on_status_and_payment_expires_at"
  ...
  create_table "food_orders", force: :cascade do |t|
    ...
    t.index ["status", "expires_at"], name: "index_food_orders_on_status_and_expires_at"
  ...
  create_table "golf_reservations", force: :cascade do |t|
    ...
    t.index ["status", "expires_at"], name: "index_golf_reservations_on_status_and_expires_at"
